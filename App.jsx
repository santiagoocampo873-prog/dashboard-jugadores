...
// ==========================================
// SUBCOMPONENTES REUTILIZABLES SOLICITADOS
// ==========================================
...
// ==========================================
// ORQUESTADOR CENTRAL DE ESTADOS (APP)
// ==========================================
...
function App() {
  ...
  const [darkMode, setDarkMode] = useState(true); // Predeterminado oscuro como la captura
  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} player={selectedPlayer} />
    </div>
  );
}
